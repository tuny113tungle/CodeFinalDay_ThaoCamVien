...
export default class DongVatKhac extends Component {
    render() {
                ...
                <View style={styles.topsc1}>
                    ...
                    <View style={styles.baGach}>
                        ...
                        <Text style={styles.txtRakib}>
                            Danh sách các loài động vật khác được nuôi trong Thảo Cầm Viên.
                        </Text>
                    ...
                    <Image source={require('./images/baoton8.png')}
                    ...
                    <ScrollView>
                        ...
                        <View style={styles.MayBe}>
                            <View style={styles.chitiet1}>
                                <Image source={require('./images/boica.png')}
                                    style={styles.imgTx}
                                />
                                <TouchableOpacity
                            ...
                            <View style={styles.chitiet1}>
                                <Image source={require('./images/saola.png')}
                                    style={styles.imgTx}
                                />
                                <TouchableOpacity
                        ...
                        <View style={styles.MayBe02}>
                            <View style={styles.chitiet1}>
                                <Image source={require('./images/lacda.png')}
                                    style={styles.imgTx}
                                />
                                <TouchableOpacity
                            ...
                            <View style={styles.chitiet1}>
                                <Image source={require('./images/kenken.png')}
                                    style={styles.imgTx}
                                />
                                <TouchableOpacity
                                >
                        ...
                        <View style={styles.MayBe02}>
                            <View style={styles.chitiet1}>
                                <Image source={require('./images/qua.png')}
                                    style={styles.imgTx}
                                />
                                <TouchableOpacity
                                >
                            ...
                            <View style={styles.chitiet1}>
                                <Image source={require('./images/baba.jpg')}
                                    style={styles.imgTx}
                                />
                                <TouchableOpacity
                                >
