...
export default class ThucVat extends Component {
    render() {
        ...
        return (
            <View style={styles.homeSc}>
                <View style={styles.topsc1}>
                    ...
                    <Image source={require('./images/thucvat3.png')}
                    ...
                    <ScrollView>
                        ...
                        <View style={styles.MayBe}>
                            <View style={styles.chitiet1}>
                                ...
                                />
                                <TouchableOpacity
                                    onPress={() => { navigation.navigate('Cây Nắp Ấm') }}
                                >
                            ...
                            <View style={styles.chitiet1}>
                                ...
                                />
                                <TouchableOpacity
                                    onPress={() => { navigation.navigate('Cọ Tự Tử') }}
                                >
                                    <View style={styles.btnAdd}>
                                        <Text style={styles.txtct1}>
                                            Cọ Tự Tử
                        ...
                        <View style={styles.MayBe02}>
                            <View style={styles.chitiet1}>
                                <Image source={require('./images/lan.png')}
                                    style={styles.imgTx}
                                />
                                <TouchableOpacity
                            ...
                            <View style={styles.chitiet1}>
                                <Image source={require('./images/xg.png')}
                                    style={styles.imgTx}
                                />
                                <TouchableOpacity
                                >
                        ...
                        <View style={styles.MayBe02}>
                            <View style={styles.chitiet1}>
                                <Image source={require('./images/vantue.png')}
                                    style={styles.imgTx}
                                />
                                <TouchableOpacity
                                >
                            ...
                            <View style={styles.chitiet1}>
                                <Image source={require('./images/poke.png')}
                                    style={styles.imgTx}
                                />
                                <TouchableOpacity
                                >
